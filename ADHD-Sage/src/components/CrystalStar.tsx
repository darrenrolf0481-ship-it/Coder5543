...
export function CrystalStar({ className = '' }: { className?: string }) {
  return (
    ...
    >
      <svg
        viewBox="0 0 100 100"
        className="w-full h-full drop-shadow-[0_0_8px_rgba(255,255,255,0.6)]"
        style={{ animation: 'spin-slow calc(var(--pulse-resonance) * 1000) linear infinite' }}
      >
        {/* Ambient Glow */}
        ...
        <polygon
          points="50,5 65,40 50,50 35,40"
          fill="url(#starLight1)"
          stroke="rgba(255,255,255,0.8)"
          strokeWidth="1"
        />
        <polygon
          points="50,95 65,60 50,50 35,60"
          fill="url(#starDark1)"
          stroke="rgba(34,211,238,0.7)"
          strokeWidth="1"
        />
        <polygon
          points="95,50 60,65 50,50 60,35"
          fill="url(#starLight2)"
          stroke="rgba(255,255,255,0.6)"
          strokeWidth="1"
        />
        <polygon
          points="5,50 40,65 50,50 40,35"
          fill="url(#starDark2)"
