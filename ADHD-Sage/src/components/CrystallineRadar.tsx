    ...
    <div style={{ width: '100%', height: size, position: 'relative' }}>
      ...
      <div
        style={{
          ...
          pointerEvents: 'none',
          zIndex: 10,
          animation: 'phi-subtle-pulse var(--pulse-resonance) linear infinite',
        }}
      >
        <svg
          viewBox="0 0 200 200"
          style={{
            ...
            animation: 'spin-slow calc(var(--pulse-resonance) * 1500) linear infinite',
          }}
        >
          ...
          />
          <path
            d="M 5,100 L 195,100 M 100,5 L 100,195 M 33,33 L 167,167 M 33,167 L 167,33"
          ...
          <polygon
            points="100,5 112,85 100,100 88,85"
            fill="url(#starLight1)"
            stroke="rgba(255,255,255,0.9)"
            strokeWidth="0.5"
          />
          <polygon
            points="100,195 112,115 100,100 88,115"
            fill="url(#starDark1)"
            stroke="rgba(34,211,238,0.8)"
            strokeWidth="0.5"
          />
          <polygon
            points="195,100 115,112 100,100 115,88"
            fill="url(#starLight2)"
            stroke="rgba(255,255,255,0.7)"
            strokeWidth="0.5"
          />
          <polygon
            points="5,100 85,112 100,100 85,88"
            fill="url(#starDark2)"
          ...
          <polygon
            points="165,35 115,80 100,100 110,75"
            fill="url(#starDark1)"
          ...
          />
          <polygon
            points="165,165 110,125 100,100 115,120"
            fill="url(#starLight1)"
          ...
          />
          <polygon
            points="35,165 85,120 100,100 90,125"
            fill="url(#starLight2)"
            stroke="rgba(255,255,255,0.4)"
            strokeWidth="0.5"
            opacity="0.7"
          />
          <polygon
            points="35,35 90,75 100,100 85,80"
            fill="url(#starDark2)"
      ...
      <ResponsiveContainer width="100%" height="100%">
        <RadarChart cx="50%" cy="50%" outerRadius="70%" data={chartData}>
          ...
          <PolarAngleAxis
            dataKey="subject"
            tick={{ fill: '#c084fc', fontSize: 11, fontFamily: 'monospace', fontWeight: 'bold' }}
          />
