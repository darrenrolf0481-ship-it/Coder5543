...
const CrystalBar = (props: any) => {
  ...
  return (
    <g>
      ...
      <path
        d={`M ${q1X},${shoulderY + 30} L ${midX},${shoulderY + 45} L ${midX},${bottomY - 30}`}
        stroke="rgba(255,255,255,0.4)"
        strokeWidth={0.5}
        fill="none"
      />
      <path
        d={`M ${q3X},${shoulderY + 15} L ${midX},${shoulderY + 35}`}
        stroke="rgba(192,132,252,0.6)"
        strokeWidth={0.5}
        fill="none"
      />
      <path
        d={`M ${midX},${shoulderY + 80} L ${q1X},${shoulderY + 100}`}
        stroke="rgba(34,211,238,0.6)"
        strokeWidth={0.5}
        fill="none"
      />
      ...
      <path
        d={`M ${midX - 0.5},${peakY + 2} L ${midX - 0.5},${bottomY}`}
...
export function QuartzBarChart({
  data,
  height = 220,
  width,
}: {
