...
const SidebarIcon: React.FC<{
  ...
  <button
    ...
    aria-label={label}
    aria-pressed={active}
    className={`group relative p-4 rounded-[28px] transition-all duration-500 ${active ? 'text-accent-500 bg-accent-950/20 border border-accent-700/50 shadow-[0_0_40px_rgba(220,38,38,0.2)] scale-110 rotate-3' : 'text-accent-950 hover:text-accent-600 hover:bg-accent-950/10 hover:scale-105'}`}
  >
...
export const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab }) => {
  return (
    <nav className="hidden md:flex w-20 border-r border-accent-900/30 flex-col items-center py-8 space-y-8 bg-[#080101] z-30 shadow-[10px_0_40px_rgba(153,27,27,0.1)] relative">
