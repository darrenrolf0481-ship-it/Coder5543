                    ...
                    {msg.role === 'ai' && (
                      <div className="flex flex-wrap gap-2 mt-3 pt-3 border-t border-accent-900/20 empty:hidden">
                        ...
                        {msg.metadata?.generatedCode && (
                          <ActionButton
                            onClick={() =>
                              handleApplyForge(msg.metadata.generatedCode, msg.metadata.isSnippet)
                            }
                            icon={Zap}
                        ...
                        {msg.text.includes('[CRITICAL_FAILURE]') && lastEditorAssistantPrompt && (
                          <ActionButton
                            onClick={() =>
                              handleEditorAssistantSubmit(undefined, lastEditorAssistantPrompt)
                            }
                            icon={RefreshCw}
                            label="Retry"
                              ...
                              <button
                                onClick={() => {
                                  if (inspectedElementRef.current) {
                                    ...
                                    setEditorOutput(
                                      (prev) =>
                                        prev + '[SYSTEM] Element HTML copied to clipboard.\n',
                                    );
                                  }
                                }}
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="grid grid-cols-1 gap-2">
                            {Object.entries(inspectedElement.styles).map(([key, value]) => (
                              <div
                                key={key}
                                className="flex flex-col gap-1 p-3 bg-accent-950/5 border border-accent-900/10 rounded-xl group/style"
                              >
                                <div className="flex items-center justify-between">
                                  <span className="text-[8px] text-accent-900 uppercase font-black">
                                    {key}
                                  </span>
                                  <button
                                    onClick={() => {
                                      if (inspectedElementRef.current) {
                                        inspectedElementRef.current.style.removeProperty(
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            <div className="p-3 bg-accent-950/5 border border-accent-900/10 rounded-xl">
                              <span className="block text-[8px] text-accent-900 uppercase font-black mb-1">
                                Width
                              </span>
                              <span className="text-[10px] font-mono text-accent-100">
                                {Math.round(inspectedElement.rect?.width || 0)}px
                              </span>
                            </div>
                            <div className="p-3 bg-accent-950/5 border border-accent-900/10 rounded-xl">
                              <span className="block text-[8px] text-accent-900 uppercase font-black mb-1">
                              ...
                              <span className="text-[10px] font-mono text-accent-100">
                                {Math.round(inspectedElement.rect?.height || 0)}px
                              </span>
                            </div>
                          </div>
                        </div>
